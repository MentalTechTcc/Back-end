...
describe('Especialidade Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'especialidade', component: EspecialidadeComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to especialidadeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEspecialidadeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEspecialidadeIdentifier).toHaveBeenCalledWith(entity);
